...
class MainActivity: FlutterActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pnConfiguration.subscribeKey = "sub-c-d559ee94-c7d5-4121-924e-d917ae4f1830"
        pnConfiguration.publishKey = "pub-c-038e84e8-3999-4650-a222-4b785449f282"
                    ...
                    handler?.let {
                        ...
                        it.post {
                            flutterEngine?.dartExecutor?.binaryMessenger?.let{
                                ...
                                .invokeMethod(
                                    actionReceived,"${receivedMessageObject.asString}"
                                );
                            }
                        }
                    }
